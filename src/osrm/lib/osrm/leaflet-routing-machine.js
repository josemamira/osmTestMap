...
},{"./instructions/de.json":4,"./instructions/en.json":5,"./instructions/fr.json":6,"./instructions/nl.json":7,"./instructions/zh-Hans.json":8,"./instructions/es.json":99}],4:[function(_dereq_,module,exports){
module.exports={
    "meta": {
    ...
    "v5": {
        "constants": {
            ...
            "modifier": {
                ...
                "slight left": "leve giro a la izquierda",
                "slight right": "leve giro a la derecha",
                "straight": "recto",
                "uturn": "media vuelta"
            },
            "lanes": {
                "xo": "Manténgase a la derecha",
                "ox": "Manténgase a la izquierda",
                "xox": "Manténgase en el centro",
                "oxo": "Manténgase a la derecha o la izquierda"
            }
        },
        "modes": {
            "ferry": {
                "default": "Tome el ferry",
                "name": "Tome el ferry ferry {way_name}",
                "destination": "Tome el ferry hacia {destination}"
            }
        },
        "arrive": {
            "default": {
                "default": "Usted a llegado a su destino en {nth}"
            },
            "left": {
                "default": "Usted a llegado a su destino en {nth}, a la izquierda"
            },
            "right": {
                "default": "Usted a llegado a su destino en {nth}, a la derecha"
            },
            "sharp left": {
                "default": "Usted a llegado a su destino en {nth}, a la izquierda"
            },
            ...
            "straight": {
                "default": "Usted a llegado a su destino en {nth}, al frente"
            }
        },
        "continue": {
            "default": {
                "default": "Continue {modifier}",
                "name": "Continue {modifier} en {way_name}",
                "destination": "Continue {modifier} hacia {destination}"
            },
            "slight left": {
                "default": "Continue girando levemente a la izquierda",
                "name": "Continue girando levemente a la izquierda en {way_name}",
                "destination": "Continue girando levemente a la izquierda hacia {destination}"
            },
            "slight right": {
                "default": "Continue girando levemente a la derecha",
                "name": "Continue girando levemente a la derecha en {way_name}",
                "destination": "Continue girando levemente a la derecha hacia {destination}"
            },
            "uturn": {
                "default": "De la vuelta",
                "name": "De la vuelta en {way_name}",
                "destination": "De la vuelta hacia {destination}"
            }
        },
        "depart": {
            "default": {
                "default": "Derecho sobre {direction}",
                "name": "Diríjase al {direction} en {way_name}"
            }
        },
        "end of road": {
            "default": {
                "default": "Gire {modifier}",
                "name": "Gire {modifier} en {way_name}",
                "destination": "Gire {modifier} hacia {destination}"
            },
            "straight": {
                "default": "Continue recto",
                "name": "Continue recto en {way_name}",
                "destination": "Continue recto hacia {destination}"
            },
            "uturn": {
                "default": "De la vuelta al final de la vía",
                "name": "De la vuelta en {way_name} al final de la via",
                "destination": "De la vuelta hacia {destination} al final de la vía"
            }
        },
        "fork": {
            "default": {
                "default": "Manténgase {modifier} en el cruce",
                "name": "Manténgase {modifier} en el cruce en {way_name}",
                "destination": "Manténgase {modifier} en el cruce hacia {destination}"
            },
            "slight left": {
                "default": "Manténgase a la izquierda en el cruce",
                "name": "Manténgase a la izquierda en el cruce en {way_name}",
                "destination": "Manténgase a la izquierda en el cruce hacia {destination}"
            },
            "slight right": {
                "default": "Manténgase a la derecha en el cruce",
                "name": "Manténgase a la derecha en el cruce en {way_name}",
                "destination": "Manténgase a la derecha en el cruce hacia {destination}"
            },
            "sharp left": {
                "default": "Tome un giro pronunciado a la izquierda en el cruce",
                "name": "Tome un giro pronunciado a la izquierda en el cruce sobre {way_name}",
                "destination": "Tome un giro pronunciado a la izquierda en el cruce hacia {destination}"
            },
            "sharp right": {
                "default": "Tome un giro pronunciado a la derecha en el cruce",
                "name": "Tome un giro pronunciado a la derecha en el cruce sobre {way_name}",
                "destination": "Tome un giro pronunciado a la derecha en el cruce hacia {destination}"
            },
            "uturn": {
                "default": "De la vuelva",
                "name": "De la vuelta en {way_name}",
                "destination": "De la vuelta hacia {destination}"
            }
        },
        "merge": {
            "default": {
                ...
                "name": "Incorpórate {modifier} en {way_name}",
        ...
        "new name": {
            ...
            "sharp left": {
                "default": "Tome un giro pronunciado a la izquierda",
                "name": "Tome un giro pronunciado a la izquierda en {way_name}",
                "destination": "Tome un giro pronunciado a la izquierda sobre {destination}"
            },
            "sharp right": {
                "default": "Tome un giro pronunciado a la derecha",
                "name": "Tome un giro pronunciado a la derecha en {way_name}",
                "destination": "Tome un pronunciado leve a la derecha sobre {destination}"
            },
            "slight left": {
                "default": "Tome un giro leve a la izquierda",
                "name": "Tome un giro leve a la izquierda en {way_name}",
                "destination": "Tome un giro leve a la izquierda sobre {destination}"
            },
            "slight right": {
                "default": "Tome un giro leve a la derecha",
                "name": "Tome un giro leve a la derecha en {way_name}",
                "destination": "Tome un giro leve a la v sobre {destination}"
            },
            "uturn": {
                "default": "De la vuelta",
                "name": "De la vuelta en {way_name}",
        ...
        "off ramp": {
            ...
            "left": {
                "default": "Tome la salida a la izquierda",
                "name": "Tome la salida a la izquierda en {way_name}",
                "destination": "Tome la salida a la izquierda hacia {destination}"
            },
            "right": {
                "default": "Tome la salida a la derecha",
                "name": "Tome la salida a la derecha en {way_name}",
                "destination": "Tome la salida a la derecha hacia {destination}"
            },
            "sharp left": {
                "default": "Tome la salida a la izquierda",
                "name": "Tome la salida a la izquierda en {way_name}",
        ...
        "on ramp": {
            "default": {
                "default": "Tome la entrada",
                "name": "Tome la entrada en {way_name}",
                "destination": "Tome la entrada hacia {destination}"
            },
            "left": {
                "default": "Tome la entrada a la izquierda",
                "name": "Tome la entrada a la izquierda en {way_name}",
                "destination": "Tome la entrada a la izquierda hacia {destination}"
            },
            "right": {
                "default": "Tome la entrada a la izquierda",
                "name": "Tome la entrada a la izquierda en {way_name}",
        ...
        "rotary": {
            "default": {
                "default": {
                    "default": "Entre en el giratorio",
                    "name": "Entre en el giratorio y salga en {way_name}",
                    "destination": "Entre en el giratorio y salga hacia {destination}"
                },
                "name": {
                    "default": "Entre en {rotary_name}",
                    "name": "Entre en {rotary_name} y salga en  {way_name}",
                    "destination": "Entre en {rotary_name} y salga hacia {destination}"
                },
                "exit": {
                    "default": "Entre en el giratorio y tome la {exit_number} salida",
                    "name": "Entre en el giratorio y tome la {exit_number} salida en {way_name}",
                    "destination": "Entre en el giratorio y tome la {exit_number} salida hacia {destination}"
                },
                "name_exit": {
                    "default": "Entre en  {rotary_name} y tome la {exit_number} salida",
                    "name": "Entre en {rotary_name} y tome la {exit_number} salida en {way_name}",
                    "destination": "Entre en {rotary_name} y tome la {exit_number} salida hacia {destination}"
                }
            }
        },
        "roundabout": {
            "default": {
                "exit": {
                    "default": "Entre en la rotonda y tome la {exit_number} salida",
                    "name": "Entre en la rotonda y tome la {exit_number} salida en {way_name}",
                    "destination": "Entre en la rotonda y tome la {exit_number} salida hacia {destination}"
                },
                "default": {
                    "default": "Entre en la rotonda",
                    "name": "Entre en la rotonda y salga en {way_name}",
                    "destination": "Entre en la rotonda y salga hacia {destination}"
                }
            }
        },
        "roundabout turn": {
            "default": {
                "default": "En la rotonda haga un {modifier}",
                "name": "En la rotonda haga un {modifier} en {way_name}",
                "destination": "En la rotonda haga un {modifier} hacia {destination}"
            },
            "left": {
                "default": "En la rotonda gire a la izquierda",
                "name": "En la rotonda gire a la izquierda en {way_name}",
                "destination": "En la rotonda gire a la izquierda hacia {destination}"
            },
            "right": {
                "default": "En la rotonda gire a la derecha",
                "name": "En la rotonda gire a la derecha en {way_name}",
                "destination": "En la rotonda gire a la derecha hacia {destination}"
            },
            "straight": {
        ...
        "turn": {
            "default": {
                "default": "Haga un {modifier}",
                "name": "Haga un {modifier} en {way_name}",
                "destination": "Haga un {modifier} hacia {destination}"
            },
            "left": {
